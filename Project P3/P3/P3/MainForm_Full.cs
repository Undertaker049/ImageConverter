...
{
    /// <summary>
    /// Description of MainForm_Full.
    /// </summary>
    public partial class MainForm_Full : Form
    {
        private Font OldFont;
        Font myFont;
        PrivateFontCollection private_fonts = new PrivateFontCollection();
        public MainForm_Full()
        {
            InitializeComponent();
        ...
        private void MainForm_Full_Paint(object sender, PaintEventArgs e)
        {
        ...
        private void DrawNeonInserts(Graphics graphics, Rectangle rectangle)
        {
            int insetsWidth = 30;
            int insetsHeight = 15;
            Pen insetsPen = new Pen(Color.Red, 3);
        ...
        {
            this.Hide();
            Form_Format_Full f3 = new Form_Format_Full();
            f3.ShowDialog();
        }
